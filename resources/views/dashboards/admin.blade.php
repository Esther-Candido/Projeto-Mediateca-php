...
@section('content')
    ...
    <div class="row">
        ...
        {{--Últimas Requisições--}}
        <div class="col-md-6">
            @component('components.generic.card', ['titulo' => 'Ultimas Requisições'])
                @component('components.req-table',['requisicoes'=>$requisicoes])
                @endcomponent
                @slot('footer')
                    <p>Agora com footer</p>
                @endslot
            @endcomponent
        </div>
    </div>
